...
function selectorSet(multiple, ri, ci, indexesUpdated = true, moving = false) {
  ...
  table.render();
  /* 二次开发新增：单元格选中回调*/
  this.data.selectCell(this.data, multiple)
}
...
function dataSetCellText(text, state = 'finished') {
  ...
  if ((cell && !cell.contentNoEditable) || !cell) {
...
export default class Sheet {
  constructor(targetEl, data) {
    ...
    // contextMenu
    this.contextMenu = new ContextMenu(() => this.getTableOffset(), !showContextmenu, this.data.settings.tableType);
    // selector
